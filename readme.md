...
- ### Многопоточность
  ...
  #### 138. Как работать с std::mutex?
    ...
    - <details><summary>Ответ:</summary>
      ...
      Вместо явного использования `lock and unlock` вы можете использовать квадратные скобки , как показано здесь , если
      вы используете блокировку с ограниченной областью действия для того преимущества, которое она дает . Однако замки
